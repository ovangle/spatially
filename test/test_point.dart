...
void main() {
  ...
  linesegmentRelationTests("Point", new Point(x: 0.0, y: 0.0));
  multipointRelationTests("Point", new Point(x: 0.0, y: 0.0));
  linestringRelationTests("Point", new Point(x: 0.0, y: 0.0));
  ...
  linestringOperatorTests("Point", new Point(x: 0.0, y: 0.0));
